...
// Функция нахождения родительского узла.
// Рекурсивно проходит и находит "родителя"
Node* parent(BST* tree, Node* node);

// Функция, находящая минимальный элемент в правом поддереве от нужного узла
int minRightTree(Node* node);

// Функция удаления элемента из дерева по значению
// Определяет случаи удаления листа, узла с одним потомком и двумя потомками
// В случае отсутствия значения элемента в дереве осуществляется выход из функции
